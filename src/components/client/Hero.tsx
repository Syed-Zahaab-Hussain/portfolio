...
const Hero: React.FC = () => {
  ...
  const fullText = "Computer Science & Engg. Student";
      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <Reveal delay={0.1}>
          <div className="h-8 md:h-10 flex items-center">
             <span className="text-xl md:text-3xl text-gray-400 font-medium">
                {text}
                <span className="animate-blink border-r-2 border-purple-500 ml-1 h-full inline-block align-middle">&nbsp;</span>
             </span>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.4}>
          <div className="flex flex-wrap items-center gap-4 mt-8 p-4 -ml-4">
            <a href="#portfolio" className="group relative px-6 py-3 rounded-lg bg-[#0a0a0a] border border-white/10 shadow-[0_0_15px_rgba(168,85,247,0.5)] hover:shadow-[0_0_25px_rgba(168,85,247,0.7)] overflow-hidden transition-all hover:bg-white/5">
              <div className="flex items-center gap-2 z-10 relative text-white font-medium">
                <Layers size={20} className="group-hover:rotate-12 transition-transform text-purple-400"/>
                <span>Projects</span>
              </div>
            </a>
